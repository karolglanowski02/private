...
namespace Microsoft{ namespace VisualStudio {namespace CppUnitTestFramework
{
...
#if _HAS_CXX17
	template<> inline std::wstring ToString<std::wstring_view>     (const std::wstring_view& t)     { RETURN_WIDE_STRING(t.data()); }
	template<> inline std::wstring ToString<std::string_view>      (const std::string_view& t)      { RETURN_WIDE_STRING(t.data()); }
#endif
	...
	public:
		...
		static void __declspec(noreturn) Fail(const wchar_t* message = NULL, const __LineInfo* pLineInfo = NULL)
		{

...
#define TEST_MODULE_INITIALIZE(methodName)\
	...
	{\
		ALLOCATE_TESTDATA_SECTION_METHOD\
		static const ::Microsoft::VisualStudio::CppUnitTestFramework::MethodMetadata s_Metadata = {L"TestModuleInitializeInfo", L#methodName, reinterpret_cast<const unsigned char*>(__FUNCTION__), reinterpret_cast<const unsigned char*>(__FUNCDNAME__)};\
\
...
#define TEST_MODULE_CLEANUP(methodName)\
	...
	{\
		ALLOCATE_TESTDATA_SECTION_METHOD\
		static const ::Microsoft::VisualStudio::CppUnitTestFramework::MethodMetadata s_Metadata = {L"TestModuleCleanupInfo", L#methodName, reinterpret_cast<const unsigned char*>(__FUNCTION__), reinterpret_cast<const unsigned char*>(__FUNCDNAME__)};\
\
		static const ::Microsoft::VisualStudio::CppUnitTestFramework::GlobalMethodInfo s_Info = {&methodName, &s_Metadata};\
		return &s_Info;\
	}\
...
#define TEST_CLASS_INITIALIZE(methodName)\
	...
	{\
		ALLOCATE_TESTDATA_SECTION_METHOD\
		static const ::Microsoft::VisualStudio::CppUnitTestFramework::MethodMetadata s_Metadata = {L"TestClassInitializeInfo", L#methodName, reinterpret_cast<const unsigned char*>(__FUNCTION__), reinterpret_cast<const unsigned char*>(__FUNCDNAME__)};\
\
		...
		s_Info.method.pVoidStaticMethod = static_cast<::Microsoft::VisualStudio::CppUnitTestFramework::GlobalMethodInfo::voidFunc>(&ThisClass::methodName);\
		return &s_Info;\
	}\
...
#define TEST_CLASS_CLEANUP(methodName)\
	...
	{\
		ALLOCATE_TESTDATA_SECTION_METHOD\
		static const ::Microsoft::VisualStudio::CppUnitTestFramework::MethodMetadata s_Metadata = {L"TestClassCleanupInfo", L#methodName, reinterpret_cast<const unsigned char*>(__FUNCTION__), reinterpret_cast<const unsigned char*>(__FUNCDNAME__)};\
\
...
#define TEST_METHOD_INITIALIZE(methodName)\
	...
	{\
		ALLOCATE_TESTDATA_SECTION_METHOD\
		static const ::Microsoft::VisualStudio::CppUnitTestFramework::MethodMetadata s_Metadata = {L"TestMethodInitializeInfo", L#methodName, reinterpret_cast<const unsigned char*>(__FUNCTION__), reinterpret_cast<const unsigned char*>(__FUNCDNAME__)};\
\
...
#define TEST_METHOD_CLEANUP(methodName)\
	...
	{\
		ALLOCATE_TESTDATA_SECTION_METHOD\
		static const ::Microsoft::VisualStudio::CppUnitTestFramework::MethodMetadata s_Metadata = {L"TestMethodCleanupInfo", L#methodName, reinterpret_cast<const unsigned char*>(__FUNCTION__), reinterpret_cast<const unsigned char*>(__FUNCDNAME__)};\
\
